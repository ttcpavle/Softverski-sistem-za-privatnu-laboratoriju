 ...
 * @author totic
 */
public class PromeniKupacForm extends OpstaEkranskaForma {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(PromeniKupacForm.class.getName());

    /**
     * Creates new form PromeniKupacForm
     */
    public PromeniKupacForm() {
        super("Promena kupca");
        initComponents();
