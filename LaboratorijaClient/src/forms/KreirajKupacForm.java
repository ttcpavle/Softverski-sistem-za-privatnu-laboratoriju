 ...
 * @author totic
 */
public class KreirajKupacForm extends OpstaEkranskaForma{
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(KreirajKupacForm.class.getName());
    ...
    public JButton getSacuvajButton() {
        return sacuvajButton;
    }

    public void setSacuvajButton(JButton sacuvajButton) {
        this.sacuvajButton = sacuvajButton;
    }
